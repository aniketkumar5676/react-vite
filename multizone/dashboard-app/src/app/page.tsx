...
export default function DashboardPage() {
  const { isLoggedIn, username, logout, updateUsername } = useAuthStore();
    ...
    <>
      {isLoading ? (
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', flexDirection: 'column' }}>
          <h1>Please login to view the dashboard</h1><br></br>
          ...
          <Layout>
            ...
            >
              <div style={{ padding: '2rem' }}>
                ...
                <Button type="primary" onClick={logout} style={{ marginTop: '2rem' }}>
                  Logout
                </Button>
              </div>
            </Content>
